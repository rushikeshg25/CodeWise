...
const AddPlaygroundButton = styled.div`
  ...
  return (
    <StyledRightComponent>
      <Header>
        ...
        })}> <span>+</span> New Folder</AddFolderButton>
      </Header>
          ...
          <FolderCard key={folderId}>
            <Header>
              ...
              <FolderIcons>
                ...
                <AddPlaygroundButton onClick={() => openModal({
                  show: true,
                  modalType: 2,
                  identifiers: {
                    folderId: folderId,
                ...
                })}><span>+</span> New Playground</AddPlaygroundButton>
              </FolderIcons>
            </Header>
